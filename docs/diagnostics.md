...
**174** documented codes, one Markdown file each. Do not hand-edit the `docs/diagnostics/*.md`
...
| `ARC-EDT` | 3 | Semantic editor: locking, transactions, history | `ARC-EDT-001` project locked by another writer, `ARC-EDT-002` rolled-back write |
