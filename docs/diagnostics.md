...
**169** documented codes, one Markdown file each. Do not hand-edit the `docs/diagnostics/*.md`
...
| `ARC-PRJ` | 13 | Project manifest, discovery, status, snapshots, metadata, policy, proposals, detach | `ARC-PRJ-001` no project, `ARC-PRJ-008` invalid UI metadata, `ARC-PRJ-011` stale proposal |
